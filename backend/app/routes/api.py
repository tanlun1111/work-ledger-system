...
from app.services import ledger_service, image_service, serial_service, enum_service
...
def upload_images(ledger_id):
    ...
    images = image_service.upload_images(ledger.id, files)
...
def serve_image(ledger_id, uuid_filename):
    file_path, mime_type = image_service.get_image_path(ledger_id, uuid_filename)
...
def delete_image(ledger_id, image_id):
    image_service.delete_image(ledger_id, image_id)
